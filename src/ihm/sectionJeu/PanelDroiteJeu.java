...
public class PanelDroiteJeu extends JPanel
{
	...
	public PanelDroiteJeu(Controleur ctrl)
	{
		...
		this.setPreferredSize(new java.awt.Dimension(100, 0));
	...
	public class PanelPiocheMarcher extends JPanel implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e) 
		{
			...
			{
				PanelDroiteJeu.this.ctrl.getEstJoueurCourant().ajouterCarteWagon(this.carteWagon);
				this.majMarcher(PanelDroiteJeu.this.ctrl.getLstCarteWagon().remove(0));
			}
		}
